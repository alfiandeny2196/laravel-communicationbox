	...
	<tr valign="top">
		...
		<td width="50%">
			...
			<table width="90%" border="0">
			  ...
			  <tr>
				<td ><strong>Jumlah Pserta (IWD) : </strong></td>
				<td align="right"><?php echo $row2[0];?> Peserta</td>
			  </tr>
			  <tr>
				<td ><strong>Jumlah Peserta Datang (IWD): </strong></td>
				<td align="right"><?php echo $row6[0];?> Peserta</td>
			  </tr>
			  <tr>
				<td colspan="2"><hr/></td>
			  </tr>
			  <tr>
				...
				<td align="right"><strong><?php echo ($row2[0]-$row6[0]);?> Peserta</strong></td>
			  </tr>
			</table>
		</td>
		<td width="50%"></td>
