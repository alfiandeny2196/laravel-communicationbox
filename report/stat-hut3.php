...
require('conn.php');
	...
	$total_booked_hut= $row3[0];
	$val_book_hut	 = $row3[0]-$row7[0];

	$proc_booked_hut 	= number_format( (100* ($val_book_hut/$total_booked_hut) ),2)."%";
	$proc_used_hut		= number_format( (100* ($row3[0]/$total_booked_hut) ),2)."%";
		...
		<td width="50%">
			...
			<table width="90%" border="0">
			  ...
			  <tr>
				...
				<td align="right"><?php echo $row3[0];?></td>
			  </tr>
			  <tr>
				<td width="60%"><strong>Jumlah Peserta Datang : </strong></td>
				<td align="right"><?php echo $row7[0];?></td>
			  </tr>
			  <tr>
				<td colspan="2"><hr/></td>
			  </tr>
